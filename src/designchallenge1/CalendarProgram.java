...
public class CalendarProgram{
    ...
    private CalendarProgram currentprog;
    ...
    {    	
		...
		for (i = 1; i <= nod; i++) {
			...
			eventnames = "";
			if(main != null)
				searchEvents(i, month, year);
			
			modelCalendarTable.setValueAt("<html><body> " + i + eventnames + "</body></html>", row, column);
		}
	...
	public CalendarProgram()
    {
		...
		cmbYear.setBounds(97, 610, 160, 40);
		...
		addevent.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				NewEvent addEvent = new NewEvent(currentprog);
			}
		});
		addevent.setBounds(489, 610, 131, 40);
	...
	public void addCalendarMain(Calendar main)
	{
		this.main = main;
	}
	
	private void searchEvents(int day, int month, int year)
	{
		eventnames = main.searchEvents(day, month+1, year);
	}
	
	public Calendar getMain()
	{
		return main;
	}
}
